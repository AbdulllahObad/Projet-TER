...
```
cd existing_repo
git remote add origin https://gitlab.com/MariemElG/projet-ter.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/MariemElG/projet-ter/-/settings/integrations)
